...
public class GearboxTransmission : Transmission
{
	...
	public AudioSource shiftas;
	public Text shifttext;
	public GasMotor variklis;
	...
	public void Shift(int dir)
	{
		...
		if(shiftas)
		{
			if(variklis.targetPitch > 0.85)
			{
				shiftTime+=variklis.targetPitch*30;
				shifttext.text = "OVER REV";
				shifttext.color = Color.red;
			}
			else if(variklis.targetPitch > 0.75)
			{
				shifttext.text = "PERFECT SHIFT";
				shifttext.color = Color.cyan;
			}
			else if(variklis.targetPitch > 0.6)
			{
				shiftTime += 10-variklis.targetPitch*5;
				shifttext.text = "GOOD SHIFT";
				shifttext.color = Color.green;
			}
			else
			{
				shiftTime += 20-variklis.targetPitch*10;
